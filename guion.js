...
const OBJECIONES = [
  ...
  "OBJECIÓN '¿esto es real / no será una estafa?': Te entiendo, hoy hay mucho humo por ahí. Por eso E-Master es real y verificable. Velo tú mismo aquí, ahí están los casos reales, las entrevistas y el día a día de la comunidad: " + INSTAGRAM_URL + " . Revísalo con calma y me dices; cuando veas que esto es de verdad, seguimos con tu ingreso al club. (Comparte SIEMPRE el Instagram en esta objeción, dentro de tu misma respuesta — no esperes a que te lo pidan.)",
  ...
  "OBJECIÓN '¿me atiendes tú directamente o alguien de tu equipo?': Tranquilo, aquí te atiendo yo directamente. Dentro del club, quienes más aplican tienen llamada 1:1 conmigo. No vas a estar solo ni te van a dejar botado: vas guiado por mí. (No menciones a 'el equipo' al responder esto: la persona quiere saber que es contigo, y lo es.)",
];
